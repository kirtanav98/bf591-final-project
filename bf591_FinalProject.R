...
source("/Users/kirtanaveeraraghavan/camplab/samples.R")
source("/Users/kirtanaveeraraghavan/camplab/counts.R")
source("/Users/kirtanaveeraraghavan/camplab/diff_expr.R")
source("/Users/kirtanaveeraraghavan/camplab/gsea.R")

ui <- fluidPage(
  theme = bs_theme(version = 5, bootswatch = "zephyr"),
  titlePanel("BF591 Final Project"),
  h4("Author: Kirtana Veeraraghavan"),
  ...
  tabsetPanel(
    tabPanel( #Sample Information Tab
      title = "Sample",
      h5("This section allows the user to load and examine a sample information matrix i.e. the metadata."),
      sidebarLayout(
        sidebarPanel( #Inputs
    ...
    tabPanel( #GSEA Tab
      title = "GSEA",
      h5("This section allows the user to use the differential gene expression results to compute gene set enrichment analysis with fgsea."),
      sidebarLayout(
        sidebarPanel( #Inputs
...
server <- function(input, output) {
  ...
  output$fgsea_table_download <- downloadHandler(
    filename = function() {"/Users/kirtanaveeraraghavan/Desktop/fgsea_c2pathway_res.csv"},
